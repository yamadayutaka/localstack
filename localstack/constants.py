...
TEST_AWS_ACCESS_KEY_ID = os.getenv("TEST_AWS_ACCESS_KEY_ID") or "LSIAQAAAAAAAQAATEST1"  # translates to account ID: 000000000001
...
SECONDARY_TEST_AWS_ACCESS_KEY_ID = os.getenv("SECONDARY_TEST_AWS_ACCESS_KEY_ID") or "LSIAQAAAAAABAAATEST2"  # translates to account ID: 000000000002
